  ...
  return (
    <>
      ...
      {(goals.length > 0 || generalSavings.length > 0) && (
        <section className="mb-6 rounded-hero tone-metas bg-gradient-brand px-5 py-6 shadow-hero overflow-hidden">
      ...
      {goals.length === 0 ? (
        <EmptyState
          icon="goal"
          illustration="goals"
          title="Aquí pones para qué ahorras"
          message="Ponerle nombre y monto a lo que quieres es lo que hace que el dinero no se vaya en otra cosa. Vas viendo cuánto te falta."
