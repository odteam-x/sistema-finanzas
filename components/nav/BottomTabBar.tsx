          ...
          <ul className="grid grid-cols-5 px-2">
              ...
              return (
                <li key={r.href}>
                  <Link
                    ...
                    aria-current={active ? "page" : undefined}
                    className={cn(
                      "flex flex-col items-center justify-center gap-0.5 pt-2 pb-1.5 min-h-[52px] text-xs font-semibold transition-colors active:scale-[0.97]",
                      active ? "text-primary-fg" : "text-muted",
                    )}
                  >
            ...
            <li>
              <button
                ...
                className={cn(
                  "flex flex-col items-center justify-center gap-0.5 pt-2 pb-1.5 min-h-[52px] w-full text-xs font-semibold transition-colors cursor-pointer active:scale-[0.97]",
